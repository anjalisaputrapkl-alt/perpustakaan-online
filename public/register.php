...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (empty($errors)) {
    try {
      ...
      // insert school (status column akan ditambah di migration)
  ...
  <div class="container">
    <div class="card" style="max-width: 500px; margin: 60px auto;">
      <div style="text-align: center; margin-bottom: 28px;">
        ...
        <p style="color: var(--text-muted); margin: 0; font-size: 13px;">Kelola perpustakaan sekolah dengan sistem yang
          modern</p>
      </div>
      ...
      <div style="text-align: center; margin-top: 28px; padding-top: 20px; border-top: 1px solid var(--border);">
        ...
        <a href="/perpustakaan-online/public/login.php" class="btn secondary"
          style="width: 100%; justify-content: center;">🔓 Login di sini</a>
      </div>
